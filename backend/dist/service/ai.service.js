...
exports.analyzeReceiptFile = void 0;
const ai_config_1 = require("../config/ai.config");
const analyzeReceiptFile = async (fileBuffer, mimeType) => {
    try {
...
`;
        const response = await ai_config_1.ai.chat.completions.create({
        ...
        throw new Error("AI-gu wuu ku guuldaraystay inuu akhriyo rasiidhkan. Fadlan dib u tijaabi.");
    }
};
exports.analyzeReceiptFile = analyzeReceiptFile;
